 ...
 *       &lt;sequence>
 *         &lt;element name="ThisDocumentIdentifier" type="{urn:ecms:schema:retailsellerinformation:request:1:0}ThisDocumentIdentifierType"/>
 *         &lt;element name="ThisDocumentDateTime" type="{urn:ecms:schema:retailsellerinformation:request:1:0}ThisDocumentDateTimeType"/>
 *         &lt;element name="From" type="{urn:ecms:schema:retailsellerinformation:request:1:0}FromType"/>
 *         &lt;element name="To" type="{urn:ecms:schema:retailsellerinformation:request:1:0}ToType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
