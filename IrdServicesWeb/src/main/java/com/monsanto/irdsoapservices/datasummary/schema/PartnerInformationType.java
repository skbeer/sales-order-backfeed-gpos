 ...
 *         &lt;element name="PartnerIdentifier" type="{urn:ecms:schema:datasummaryreport:response:1:0}PartnerIdentifierType" maxOccurs="unbounded"/>
 *         &lt;element name="ContactInformation" type="{urn:ecms:schema:datasummaryreport:response:1:0}ContactInformationType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="AddressInformation" type="{urn:ecms:schema:datasummaryreport:response:1:0}AddressInformationType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
