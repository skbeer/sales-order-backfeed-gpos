...
public class AgreementStatusHelper {
    ...
    public AgreementStatusResponseType getAgreementStatus(AgreementStatusRequest agreementStatusRequest) throws AgreementStatusFault {
        ...
        try {
            logger.info("Starting to retrieve Agreement Status information v20160310");
            ...
            List<AgreementStatusInfo> agreementStatusList = agreementStatusDao.getAgreementStatusInfo(glnList, assignedBySellerList,Arrays.asList(SYSTEM_CODE_GLN, SYSTEM_CODE_SAP),null);
