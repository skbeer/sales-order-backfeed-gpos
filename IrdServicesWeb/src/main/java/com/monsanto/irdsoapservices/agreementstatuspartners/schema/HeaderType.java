 ...
 *       &lt;sequence>
 *         &lt;element name="ThisDocumentIdentifier" type="{urn:cidx:names:specification:ces:schema:all:5:3}ThisDocumentIdentifierType"/>
 *         &lt;element name="ThisDocumentDateTime" type="{urn:cidx:names:specification:ces:schema:all:5:3}ThisDocumentDateTimeType"/>
 *         &lt;element name="From" type="{urn:cidx:names:specification:ces:schema:all:5:3}FromType"/>
 *         &lt;element name="To" type="{urn:cidx:names:specification:ces:schema:all:5:3}ToType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
