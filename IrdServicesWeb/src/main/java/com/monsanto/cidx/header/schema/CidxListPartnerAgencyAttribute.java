...
/**
 * <p>Java class for cidxListPartnerAgencyAttribute.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="cidxListPartnerAgencyAttribute">
 ...
 * 
 */
@XmlType(name = "cidxListPartnerAgencyAttribute")
@XmlEnum
public enum CidxListPartnerAgencyAttribute {
    ...
    CidxListPartnerAgencyAttribute(String v) {
        value = v;
    }
    ...
    public static CidxListPartnerAgencyAttribute fromValue(String v) {
        for (CidxListPartnerAgencyAttribute c: CidxListPartnerAgencyAttribute.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
