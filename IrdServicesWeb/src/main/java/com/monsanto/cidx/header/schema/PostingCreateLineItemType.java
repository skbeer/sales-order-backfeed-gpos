...
/**
 * <p>Java class for PostingCreateLineItemType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PostingCreateLineItemType">
 *   &lt;complexContent>
...
@XmlType(name = "PostingCreateLineItemType", propOrder = {
    "lineNumber",
...
public class PostingCreateLineItemType {
    ...
    protected List<Object> shipToAndShipFrom;
    ...
    /**
     * Gets the value of the shipToAndShipFrom property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the shipToAndShipFrom property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getShipToAndShipFrom().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getShipToAndShipFrom() {
        if (shipToAndShipFrom == null) {
            shipToAndShipFrom = new ArrayList<Object>();
        }
        return this.shipToAndShipFrom;
    }
