 ...
 *       &lt;sequence>
 *         &lt;element ref="{urn:cidx:names:specification:ces:schema:all:5:0}MinimumMeasurement"/>
 *         &lt;element ref="{urn:cidx:names:specification:ces:schema:all:5:0}MaximumMeasurement"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class MeasurementRangeType {
    ...
    @XmlElement(name = "MinimumMeasurement", required = true)
    protected MinimumMeasurementType minimumMeasurement;
    @XmlElement(name = "MaximumMeasurement", required = true)
