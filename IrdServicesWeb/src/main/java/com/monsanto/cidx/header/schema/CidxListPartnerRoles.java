...
/**
 * <p>Java class for cidxListPartnerRoles.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="cidxListPartnerRoles">
 ...
 * 
 */
@XmlType(name = "cidxListPartnerRoles")
@XmlEnum
public enum CidxListPartnerRoles {
    ...
    public static CidxListPartnerRoles fromValue(String v) {
        for (CidxListPartnerRoles c: CidxListPartnerRoles.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
