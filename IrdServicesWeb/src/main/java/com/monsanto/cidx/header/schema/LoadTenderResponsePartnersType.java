...
/**
 * <p>Java class for LoadTenderResponsePartnersType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LoadTenderResponsePartnersType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element ref="{urn:cidx:names:specification:ces:schema:all:5:0}Carrier"/>
 *         &lt;element ref="{urn:cidx:names:specification:ces:schema:all:5:0}ShipFrom" maxOccurs="unbounded"/>
...
@XmlType(name = "LoadTenderResponsePartnersType", propOrder = {
    "carrier",
    "shipFrom",
    "shipTo",
    "otherPartner"
})
public class LoadTenderResponsePartnersType {

    @XmlElement(name = "Carrier", required = true)
    protected CarrierType carrier;
    @XmlElement(name = "ShipFrom", required = true)
    protected List<ShipFromType> shipFrom;
    ...
    public List<ShipFromType> getShipFrom() {
        if (shipFrom == null) {
            shipFrom = new ArrayList<ShipFromType>();
        }
