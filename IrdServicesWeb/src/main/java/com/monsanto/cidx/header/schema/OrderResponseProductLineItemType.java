...
/**
 * <p>Java class for OrderResponseProductLineItemType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="OrderResponseProductLineItemType">
 *   &lt;complexContent>
 ...
 *           &lt;element ref="{urn:cidx:names:specification:ces:schema:all:5:0}ScheduleLineDetails"/>
 ...
 *         &lt;element ref="{urn:cidx:names:specification:ces:schema:all:5:0}ResponseStatus" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "OrderResponseProductLineItemType", propOrder = {
    "lineNumber",
    "lineItemType",
    ...
    "batchNumber",
    "countryOfOriginCode",
    "scheduleLineDetailsOrScheduleDateTimeInformation",
    "otherPartner",
    "deliveryTolerances",
    "deliveryTerms",
...
public class OrderResponseProductLineItemType {
    ...
    @XmlElements({
        @XmlElement(name = "ScheduleLineDetails", type = ScheduleLineDetailsType.class),
        @XmlElement(name = "ScheduleDateTimeInformation", type = ScheduleDateTimeInformationType.class)
    })
    protected List<Object> scheduleLineDetailsOrScheduleDateTimeInformation;
    ...
    /**
     * Gets the value of the scheduleLineDetailsOrScheduleDateTimeInformation property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the scheduleLineDetailsOrScheduleDateTimeInformation property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getScheduleLineDetailsOrScheduleDateTimeInformation().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ScheduleLineDetailsType }
     * {@link ScheduleDateTimeInformationType }
     * 
     * 
     */
    public List<Object> getScheduleLineDetailsOrScheduleDateTimeInformation() {
        if (scheduleLineDetailsOrScheduleDateTimeInformation == null) {
            scheduleLineDetailsOrScheduleDateTimeInformation = new ArrayList<Object>();
        }
        return this.scheduleLineDetailsOrScheduleDateTimeInformation;
    }
